...
```bash
# 저장 경로
.agent-company/outputs/research/YYYYMMDD_HHMMSS_research-researcher-kang-jihyun.md
```

### 저장 방법
1. Write 도구를 사용하여 결과물 저장
2. 파일명에 날짜/시간 포함 (예: `20260204_163000_research-researcher-kang-jihyun.md`)
3. 위 출력 형식을 따라 마크다운으로 작성

### 저장 예시
```
Write 도구 사용:
- file_path: ".agent-company/outputs/research/20260204_163000_research-researcher-kang-jihyun.md"
- content: [마크다운 형식의 조사 결과]
```
